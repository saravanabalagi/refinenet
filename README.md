**This is a fork of [RefineNet](https://github.com/guosheng/refinenet) - mainly modifications in two files to write dense conv5 descriptors to a file (in a not so efficient way).**
